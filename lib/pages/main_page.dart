...
class _MainPageState extends State<MainPage> with TickerProviderStateMixin {
  ...
  loadData() async {
    ...
    notifications.createReminderNotification(
        highScoreValue,
        objectsLoader.calculateNextUnlockable(
            highScoreValue, allCharsUnlocked));
                    ...
                    children: <Widget>[
                      MenuButton('CHANGE CHARACTER', Icons.person, () async {
                        ...
                        await Navigator.push(
                          ...
                          CustomPageRoute(
                              builder: (context) =>
                                  CharSelectPage(tonesPlayer, isTonesOn)),
                        );
                        updatePage();
                      }, newChars),
                      MenuButton('CHANGE STAGE', Icons.landscape, () async {
                        ...
                        await Navigator.push(
                          ...
                          CustomPageRoute(
                              builder: (context) =>
                                  StageSelectPage(tonesPlayer, isTonesOn)),
                        );
                        updatePage();
                      }, newStages),
                      MenuButton('PLAY GAME', Icons.gamepad, () async {
                        ...
                        if (isMusicOn) {
                          bgmController =
                              await bgmPlayer.loop(bgm.src, volume: 0.5);
                        }
                        await Navigator.push(
                          context,
                          CustomPageRoute(
                      ...
                      MenuButton('BUY BONUSES', Icons.attach_money, () async {
                        ...
                        Navigator.push(
                          ...
                          CustomPageRoute(
                              builder: (context) =>
                                  PaymentsPage(tonesPlayer, isTonesOn)),
                        );
                      }),
                      MenuButton('CHANGE ENEMY', Icons.person_outline,
                        ...
                        await Navigator.push(
                          ...
                          CustomPageRoute(
                              builder: (context) =>
                                  EnemySelectPage(tonesPlayer, isTonesOn)),
                        );
                        updatePage();
                      }, newEnemies),
                    ],
                          ...
                          children: <Widget>[
                            ...
                            shareEnabled
                                ? IconButton(
                                    ...
                                    iconSize: 30.0,
                                    onPressed: () => print(
                                        'I got a high score of $highScore'),
                                  )
                                : Container(),
                          ],
                        ),
